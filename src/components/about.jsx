        ...
        <div className="portfolio-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>Coming from the CS background, I have good grasp over Digital Signature Algorithm.</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I started developing a special Interest on the Flutter and started development on my own.</p>
                </div>
                </div>
            </div>
